...
<div class="d-grid col-6 mx-auto">
                <button type="submit" class="btn btn-primary btn-block mb-4 tombol">{{ __('Login') }}</button>
              </div>
              <p class="text-center">Have an account ? <a href="{{ url('register') }}" class="text-decoration-none">Sign Up</a></p>
            </form>
          </div>
        </div>
      </div>
